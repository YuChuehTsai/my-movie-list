(function () {
  ...
  pagination.addEventListener('click', event => {
    ...
    paginationNumber = Number(event.target.dataset.page)
    if (event.target.tagName === 'A') {
      if (revealTypeString === "card") {
        getPageData(paginationNumber)
      } else if (revealTypeString === "list") {
        getListPageData(paginationNumber)
      }
    }
  })
    ...
    data.forEach(function (item, index) {
      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item">
          <h6 class="card-title float-left">${item.title}</h6>
